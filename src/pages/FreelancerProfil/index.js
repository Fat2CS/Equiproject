      ...
      <div className="flex-1 flex flex-wrap">
        ...
        <div className="flex-1 p-4 w-full ">
          ...
          <div className=" mt-8 flex flex-col md:flex-row  space-x-0 space-y-2 md:space-x-4 md:space-y-0  ">
            ...
            <div className="w-full md:w-2/3 bg-black-button border border-border-black-button p-4 shadow rounded-lg  text-letter-grey overflow-y-auto relative">
          ...
          <div className="w-full md:w-2/3 mt-10 bg-black-button border border-border-black-button p-4 shadow rounded-lg  text-letter-grey overflow-y-auto">
            <div className="flex justify-end">
              <FaPencil className="text-letter-orange mt-1 mr-2" />
            </div>
            <h1>Expériences </h1>
          ...
          <div className=" h-40vh md:flex  md:space-x-10 md:text-center mt-8 bg-black-button border border-border-black-button p-4 shadow rounded-lg text-letter-grey m-auto ">
            <div className=" sm:text-basemd:mt-10">
              {" "}
              <h1>Candidatures </h1>
              <div className="mt-4">
